...
const Button = ({ children, colorScheme, ...props }: ButtonProps) => {
  ...
  return (
    <button
      className="bg-blue-500 text-white px-4 py-2 rounded-md transition-all duration-300 ease-in-out hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 w-full"
      {...props}
    >
      {children}
    </button>
